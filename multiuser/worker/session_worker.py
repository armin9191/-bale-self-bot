...
SWEARS = [
    "کس ننت", "گودال سریال نبود سوراخ ننت بود کونی", "حرومزاده", "کیر کیر نکن پسرم", "کیرمتو اول و اخرت",
    "کسکش", "مادرجنده", "از کون دارت میزنم", "کسکش گوشت تلخ", "کس ننت باش؟",
    "کس خارت", "ننه جنده", "باباتم گی بوده؟ خانوادگی میدین همیشه؟", "کونتو پاره میکنم حرومی", "باباتو ننتو خارتو همزمان تریسام زدم باهاشون",
]
